-- Example of using Language.C (from 2009)
-- Referenced from http://stackoverflow.com/questions/6289950/
-- #include <standard_discalimer.h>
-- Otherwise use for whatever you want
import System.IO
